...
export default function Home() {
  ...
  const purchases = [
    ...
    "Sarah M. just purchased Cologne Vendors!",
    "Mike R. just purchased Designer Bags!",
    "Jessica K. just purchased Sneakers Vendors!",
    "Tyler B. just purchased Watches Vendors!",
    "Alex P. just purchased Bapee Vendor!",
    "Jordan L. just purchased Essentials Vendor!",
    "Taylor H. just purchased LV Vendors!",
    "Morgan D. just purchased Phone Vendor!",
    "Casey R. just purchased Puffer Jacket Vendor!",
    "Riley J. just purchased Clothing Vendor!",
    "Jamie W. just purchased Designer Glasses Vendor!",
    "Skylar N. just purchased Spyder Vendor!",
    "Dakota S. just purchased Starhell Vendor!",
    "Parker M. just purchased Tiers Denim Vendor!",
    "Avery K. just purchased Watch Vendor!",
    "Quinn B. just purchased Shorts Vendor Bundle!",
    "Reese T. just purchased Earphone Vendor!",
    "Sage L. just purchased Winters Best Sellers!",
    "Cameron H. just purchased Designer Bag Supplier!",
    "Emerson P. just purchased All Vendors Bundle!",
    "Finley R. just purchased Sneaker Vendor!",
    "Kai M. just purchased Essentials Vendor!",
    "River S. just purchased Clothing Vendor!",
    "Rowan J. just purchased Bapee Vendor!",
  ];
